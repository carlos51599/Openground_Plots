...
CONFIG = {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    "parameter": {
        "name": "CoefficientVolumeCompressibility",  # MODIFICATION POINT: Change to any parameter
        "output_folder_name": "CoefficientVolumeCompressibilityvsDepth",  # MODIFICATION POINT: Custom output folder name
        "display_name": "mv (m²/MN)",  # For axis labels
