...
IMPLEMENTATION:
- Line ~3000: Calculate investigation_counts dictionary
- Line ~3100: Add count to regular trace legend names
- Line ~3150: Add count to dummy circle trace legend names
- Line ~3180: Add total count trace to legend
...
CONFIG = {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    "parameter": {
        "name": "Initial Shear Modulus",  # MODIFICATION POINT: Change to any parameter
        "display_name": "Initial Shear Modulus (MPa)",  # For axis labels
    ...
    "mappings": {
        ...
        "column_variations": {
            ...
            "top_depth": [
                ...
                "ResponseZoneTop",
                "Depth Top",
                "Depth",  # Added for Pressuremeter Test Results - General.csv
            ],
        },
    },
    # ═══════════════════════════════════════════════════════════════════════
    ...
    "manual_outlier_exclusion": {
        ...
        "sheets": {
            ...
            "Initial Shear Modulus": "InitialShearModulus",  # Update with actual sheet name if different
        },
        "match_tolerance": {
    ...
    # Only Pressuremeter Test Results is mapped for Initial Shear Modulus parameter
    # ═══════════════════════════════════════════════════════════════════════
    "csv_source_settings": {
