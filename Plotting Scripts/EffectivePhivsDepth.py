#!/usr/bin/env python3
"""
Multi-Source Parameter Plotting System - Effective Angle of Friction vs Depth
...
Responsibility:
Generates effective angle of friction vs depth scatter plots by consolidating data from multiple CSV sources
...
CONFIG = {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    "parameter": {
        "name": "EffectiveAngleFriction",  # MODIFICATION POINT: Change to any parameter
        "display_name": "Effective Angle of Friction (°)",  # For axis labels
